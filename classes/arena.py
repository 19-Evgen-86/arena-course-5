...
class Arena(metaclass=BaseSingleton):
    ...
    def _stamina_regeneration(self):
        ...
        if self.player.stamina < self.player.unit_class.max_stamina:
            stamina_per_turn = self.player.stamina + self.STAMINA_PER_ROUND
            if stamina_per_turn < self.player.unit_class.max_stamina:
                self.player.stamina = stamina_per_turn
            else:
                self.player.stamina = self.player.unit_class.max_stamina

        if self.enemy.stamina < self.enemy.unit_class.max_stamina:
            stamina_per_turn = self.enemy.stamina + self.STAMINA_PER_ROUND
            if stamina_per_turn < self.enemy.unit_class.max_stamina:
                self.enemy.stamina = stamina_per_turn
            else:
